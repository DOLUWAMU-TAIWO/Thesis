...
HD_PWD='C:/Users/doluwamu.kaye/Documents/GitHub/Thesis/VC707test/VC707test.runs/Virtex_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Virtex_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Virtex_microblaze_0_0.tcl
