...
HD_PWD='C:/Users/doluwamu.kaye/Documents/GitHub/Thesis/VC707test/VC707test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Virtex_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Virtex_wrapper.tcl
