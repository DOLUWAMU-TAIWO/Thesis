...
HD_PWD='C:/Users/doluwamu.kaye/Documents/GitHub/Thesis/VC707test/VC707test.runs/Virtex_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Virtex_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Virtex_axi_gpio_0_1.tcl
