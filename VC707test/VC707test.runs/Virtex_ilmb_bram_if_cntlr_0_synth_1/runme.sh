...
HD_PWD='C:/Users/doluwamu.kaye/Documents/GitHub/Thesis/VC707test/VC707test.runs/Virtex_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Virtex_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Virtex_ilmb_bram_if_cntlr_0.tcl
