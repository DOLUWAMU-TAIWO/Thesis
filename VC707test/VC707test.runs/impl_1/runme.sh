...
HD_PWD='C:/Users/doluwamu.kaye/Documents/GitHub/Thesis/VC707test/VC707test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Virtex_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Virtex_wrapper.tcl -notrace
