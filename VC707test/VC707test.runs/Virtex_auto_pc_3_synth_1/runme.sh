...
HD_PWD='C:/Users/doluwamu.kaye/Documents/GitHub/Thesis/VC707test/VC707test.runs/Virtex_auto_pc_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Virtex_auto_pc_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Virtex_auto_pc_3.tcl
