...
--Date        : Fri Dec 22 12:04:59 2023
--Host        : CN010 running 64-bit major release  (build 9200)
--Command     : generate_target Virtex_wrapper.bd
...
architecture STRUCTURE of Virtex_wrapper is
  component Virtex is
  port (
    ddr3_sdram_dq : inout STD_LOGIC_VECTOR ( 63 downto 0 );
    ddr3_sdram_dqs_p : inout STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  end component Virtex;
begin
Virtex_i: component Virtex
     port map (
